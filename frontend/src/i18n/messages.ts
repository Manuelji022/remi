...
export const messages = {
  en: {
    ...
    'auth.twoFactorRequiredError':
      'Two-factor verification is required. Please try logging in again.',
    ...
    'auth.signupOtpStartError':
      'Your account was created, but verification could not be started. Please log in again.',
    'auth.otpTitle': 'Check your email',
    'auth.otpCopy': 'Enter the 6-digit code we sent to your email address.',
    'auth.signupOtpCopy':
      'Your account was created. Verify this code to finish signing in.',
    ...
    'auth.otpSendError': 'Unable to send the verification code.',
    'auth.otpVerifyError': 'The code is invalid or has expired.',
    ...
    'auth.resetPasswordError': 'Unable to send reset link.',
    'auth.resetPasswordTitle': 'New password',
    'auth.resetPasswordCopy': 'Enter a new password for your account.',
    ...
    'planner.weekNavigationLabel': 'Week navigation',
    ...
    'preferences.recipeSlotHelp':
      'Choose whether this recipe is for lunch or dinner',
  ...
  es: {
    ...
    'auth.twoFactorRequiredError':
      'La verificación en dos pasos es obligatoria. Vuelve a iniciar sesión.',
    ...
    'auth.signupOtpStartError':
      'Tu cuenta se ha creado, pero no se pudo iniciar la verificación. Vuelve a iniciar sesión.',
    'auth.otpTitle': 'Revisa tu email',
    'auth.otpCopy': 'Introduce el código de 6 dígitos que enviamos a tu email.',
    'auth.signupOtpCopy':
      'Tu cuenta se ha creado. Verifica este código para terminar de iniciar sesión.',
    ...
    'auth.otpSendError': 'No se pudo enviar el código de verificación.',
    'auth.otpVerifyError': 'El código no es válido o ha caducado.',
    ...
    'planner.weekNavigationLabel': 'Navegación de semana',
    'planner.previousWeek': 'Semana anterior',
